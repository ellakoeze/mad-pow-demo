					...
					function( dfd ) {
						...
						if( expanded ) {
							...
							$el.find('.va-content').hide();
                                                        console.log("I closed it!");
                                                         $el.find('.va-title').empty();
                                                        $el.find('.va-title').append("<a href=# class='closed-arrow'><img src='images/arrows-07.png'></a>");
						...
						// if it's closed..
							...
							othersHeight= Math.ceil( ( settings.accordionH - settings.expandedHeight ) / ( settings.visibleSlices - 1 ) );
                                                         $el.find('.va-title').empty();
                                                         $el.find('.va-title').append("Hi Teresa! Let's get started<a href=#><img src='images/arrows-06.png'></a></div>");
